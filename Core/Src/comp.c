...
void HAL_COMP_MspInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = PHASE_B_CURRENT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PHASE_B_CURRENT_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END COMP3_MspInit 0 */
    ...
    PA0     ------> COMP3_INP
    */
    GPIO_InitStruct.Pin = PHASE_A_CURRENT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PHASE_A_CURRENT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(PHASE_B_CURRENT_GPIO_Port, PHASE_B_CURRENT_Pin);
  ...
  /* USER CODE END COMP3_MspDeInit 0 */
    ...
    PA0     ------> COMP3_INP
    */
    HAL_GPIO_DeInit(PHASE_A_CURRENT_GPIO_Port, PHASE_A_CURRENT_Pin);
